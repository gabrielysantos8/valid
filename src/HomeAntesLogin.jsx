...
import HeaderAntesLogin from "./components/HeaderAntesLogin";

function HomeAntesLogin() {
  return (
    <div className="home">
      ...
      <section className="fundoverde2 secverificardoc">
        ...
        <div className="btn-verfi1doc">
          <Link to= "/login">Verificar meu primeiro documento</Link>
          <FaArrowRight />
        </div>
